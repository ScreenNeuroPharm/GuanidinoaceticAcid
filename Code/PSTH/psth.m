...
function [psth_count, latency, FullStimWin]= psth (peak_train, artifact, fs, bin, cancw, psthend);
% psth.m
...
if (n>=1)                                                              % number of artifact must be at least 1
    ...
    psth_count=(psth_count/n); % Normalization - Maximum is '1' only if the PSTHbin==PeakDetection_bin
